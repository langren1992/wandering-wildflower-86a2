...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wandering-wildflower-86a2
```

A live public deployment of this template is available at [https://wandering-wildflower-86a2.templates.workers.dev](https://wandering-wildflower-86a2.templates.workers.dev)
